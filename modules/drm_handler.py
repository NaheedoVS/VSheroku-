...
#........................................................................................................................................................................................
            ...
            if "jw-prod" in url:
                cmd = f'yt-dlp -o "{name}.mp4" "{url}" {postprocessor}'
            elif "webvideos.classplusapp." in url:
                cmd = f'yt-dlp --add-header "referer:https://web.classplusapp.com/" --add-header "x-cdn-tag:empty" -f "{ytf}" "{url}" -o "{name}.mp4" {postprocessor}'
            elif "youtube.com" in url or "youtu.be" in url:
                cmd = f'yt-dlp --cookies youtube_cookies.txt -f "{ytf}" "{url}" -o "{name}".mp4 {postprocessor}'
            else:
                cmd = f'yt-dlp -f "{ytf}" "{url}" -o "{name}.mp4" {postprocessor}'
